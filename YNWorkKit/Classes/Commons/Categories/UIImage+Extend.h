...
/**
 Image type.
 */
typedef NS_ENUM(NSUInteger, YNImageType) {
    YNImageTypeUnknown = 0, ///< unknown
    YNImageTypeJPEG,        ///< jpeg, jpg
    YNImageTypeJPEG2000,    ///< jp2
    YNImageTypeTIFF,        ///< tiff, tif
    YNImageTypeBMP,         ///< bmp
    YNImageTypeICO,         ///< ico
    YNImageTypeICNS,        ///< icns
    YNImageTypeGIF,         ///< gif
    YNImageTypePNG,         ///< png
    YNImageTypeWebP,        ///< webp
    YNImageTypeOther,       ///< other image format
};
