...
{
    static IOManager *_defaultInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _defaultInstance = [[IOManager alloc] initWithPathType:IOManagerSavePathTypeDocument];
    });
...
@implementation IOManager (NSUserDefaultsManager)
...
@implementation IOManager (ArchiveObjectManager)
